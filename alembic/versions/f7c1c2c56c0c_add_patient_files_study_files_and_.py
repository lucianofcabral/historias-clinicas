...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_patient_files_file_category"), "patient_files", ["file_category"], unique=False
    )
    op.create_index(
        op.f("ix_patient_files_file_path"), "patient_files", ["file_path"], unique=False
    )
    op.create_index(
        op.f("ix_patient_files_patient_id"), "patient_files", ["patient_id"], unique=False
    )
    op.create_table(
        "consultation_files",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_consultation_files_consultation_id"),
        "consultation_files",
        ["consultation_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_consultation_files_file_path"), "consultation_files", ["file_path"], unique=False
    )
    op.create_table(
        "study_files",
        sa.Column("id", sa.Integer(), nullable=False),
